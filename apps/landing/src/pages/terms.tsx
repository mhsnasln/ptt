        ...
        <div data-custom-class="body">
          <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
            ...
            >
              ...
              <strong>
                <span style={{lineHeight: '150%', fontFamily: 'Arial', fontSize: '26px'}}>
                  <bdt className="block-component" />
                  <h1 className="question">TERMS OF SERVICE</h1>
            ...
            >
              ...
              >
                ...
                <strong>
                  <span style={{color: 'rgb(127,127,127)', fontSize: '14.6667px', textAlign: 'justify'}}>&nbsp;</span>
                </strong>
                <span style={{color: 'rgb(127, 127, 127)', fontSize: '15px', textAlign: 'justify'}}>
                  <bdt
          ...
          <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
            <div className="MsoNormal" data-custom-class="heading_1" id="agreement" style={{lineHeight: '1.5'}}>
              ...
              <strong>
                <span style={{lineHeight: '115%', fontFamily: 'Arial', fontSize: '19px'}}>1. AGREEMENT TO TERMS</span>
              </strong>
            </div>
          </div>
          <div align="center" style={{textAlign: 'left', lineHeight: 1}}>
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5'}}>
              <span style={{fontSize: '15px'}}>
                <span style={{lineHeight: '115%', fontFamily: 'Arial', color: 'rgb(89, 89, 89)'}}>
                  ...
                  make changes or modifications to these Terms of Use <bdt className="block-component" />
                  from time to time
                  <bdt className="else-block" />. We will alert you about any changes by updating the “Last updated”
                      ...
                      <bdt data-type="conditional-block">
                        <bdt data-type="body">
                          <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>
                            ...
                            you are a minor, you must have your parent or guardian read and agree to these Terms of Use
                          </span>
                          <span style={{color: 'rgb(89, 89, 89)', fontSize: '14.6667px'}}>&nbsp;</span>
                          <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>prior to you using the Site.</span>
                        </bdt>
                      </bdt>
                    </bdt>
                  </span>
          ...
          <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
            ...
            <div className="MsoNormal" data-custom-class="heading_1" id="ip" style={{lineHeight: '1.5'}}>
              ...
              <strong>
                <span style={{lineHeight: '115%', fontFamily: 'Arial', fontSize: '19px'}}>
          ...
          <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
            ...
            <div className="MsoNormal" data-custom-class="heading_1" id="userreps" style={{lineHeight: '1.5'}}>
              ...
              <strong>
                <span style={{lineHeight: '115%', fontFamily: 'Arial', fontSize: '19px'}}>3. USER REPRESENTATIONS</span>
              </strong>
            </div>
          </div>
          <div align="center" style={{textAlign: 'left', lineHeight: 1}}>
              ...
              <bdt className="block-container if" data-type="if" id="d2d82ca8-275f-3f86-8149-8a5ef8054af6">
                <bdt data-type="conditional-block">
                  ...
                  <bdt data-type="body">
                    ...
                    <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>1)</span>
                    <span style={{color: 'rgb(89, 89, 89)', fontSize: '11pt'}}>&nbsp;</span>
                    <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>
                    ...
                    <span style={{color: 'rgb(89, 89, 89)', fontSize: '11pt'}}>&nbsp;</span>
                    <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>as necessary;</span>
                  </bdt>
                </bdt>
          ...
          <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
              ...
              <bdt className="block-container if" data-type="if">
                <bdt data-type="conditional-block">
                  <bdt data-type="body">
                    ...
                    >
                      <span
                        style={{fontSize: '15px', lineHeight: '115%', fontFamily: 'Arial', color: 'rgb(89, 89, 89)'}}
                      >
            ...
            <div className="MsoNormal" data-custom-class="heading_1" id="payment" style={{lineHeight: '1.5'}}>
              ...
              <strong>
                <span style={{lineHeight: '115%', fontFamily: 'Arial', fontSize: '19px'}}>5. FEES AND PAYMENT</span>
              </strong>
            </div>
            ...
            <div className="MsoNormal" style={{textAlign: 'justify', lineHeight: 1}}>
              <div className="MsoNormal" style={{lineHeight: '17.25px'}}>
                ...
                >
                  <span style={{fontSize: '15px', lineHeight: '16.8667px', color: 'rgb(89, 89, 89)'}}>
                    <bdt
              ...
              >
                <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5', textAlign: 'left'}}>
                  <span style={{lineHeight: '115%', color: 'rgb(89, 89, 89)'}}>
                    ...
                    prices at any time. All payments shall be in <bdt className="question">U.S. dollars</bdt>.
                  </span>
                </div>
              </span>
              <span
              ...
              >
                ...
                <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5', textAlign: 'left'}}>
                  <span style={{fontSize: '15px', lineHeight: '115%', color: 'rgb(89, 89, 89)'}}>
            ...
            <div className="MsoNormal" style={{textAlign: 'justify', lineHeight: 1}}>
              ...
              <bdt className="block-container if" data-type="if" id="4380167d-5abe-b98f-f389-f707429e6c52">
                ...
                >
                  ...
                  <strong>
                    <span style={{lineHeight: '115%', fontFamily: 'Arial', fontSize: '19px'}}>6. CANCELLATION</span>
                  </strong>
                </div>
              </bdt>
            </div>
                      ...
                      <span style={{fontSize: '15px', lineHeight: '16.8667px', color: 'rgb(89, 89, 89)'}}>
                        <bdt className="block-container if" data-type="if" id="24327c5d-a34f-f7e7-88f1-65a2f788484f">
                          <bdt data-type="conditional-block">
                            ...
                            by other users of the Site and through third-party websites. As such, any Contributions you
                ...
                <bdt data-type="body">
                  ...
                  <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
                    ...
                    >
                      ...
                      <strong>
                        <span style={{lineHeight: '115%', fontFamily: 'Arial', fontSize: '19px'}}>11. SUBMISSIONS</span>
                      </strong>
                    </div>
                  </div>
                  <div align="center" style={{textAlign: 'left', lineHeight: 1}}>
                    ...
                    <div className="MsoNormal" style={{textAlign: 'justify', lineHeight: '115%'}}>
                      ...
                      >
                        ...
                        >
                          ...
                          2.101. If our services are acquired by or on behalf of any agency not within the Department of
                          Defense (“DOD”), our services are subject to the terms of these Terms of Use in accordance
                          with FAR 12.212 (for computer software) and FAR 12.211 (for technical data). If our services
                          are acquired by or on behalf of any agency within the Department of Defense, our services are
                          subject to the terms of these Terms of Use in accordance with Defense Federal Acquisition
                        ...
                        >
                          7015 applies to technical data acquired by the DOD. This U.S. Government Rights clause is in
                          lieu of, and supersedes, any other FAR, DFARS, or other clause or provision that addresses
                        ...
                        <bdt data-type="body">
                          <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5'}}>
                            ...
                            >
                              ...
                              <bdt className="block-component" />. If you access the Site from any other region of the
                    ...
                    >
                      ...
                      <strong>
                        <span style={{lineHeight: '115%', fontFamily: 'Arial'}}>
                          <span style={{fontSize: '19px'}}>16. MODIFICATIONS AND INTERRUPTIONS</span>
                        </span>
                      </strong>
                    </div>
                  </div>
                  ...
                  <div align="center" style={{textAlign: 'left', lineHeight: '1.5'}}>
                    ...
                    <div className="MsoNormal" data-custom-class="heading_1" id="law" style={{lineHeight: '1.5'}}>
                      ...
                      <strong>
                        <span style={{lineHeight: '115%', fontFamily: 'Arial'}}>
                          <span style={{fontSize: '19px'}}>17. GOVERNING LAW</span>
                        </span>
                      </strong>
                    </div>
                    <div className="MsoNormal" style={{lineHeight: 1}}>
                    ...
                    <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5'}}>
                      <span style={{fontSize: '15px'}}>
                        ...
                        <bdt className="block-component" />
                        <bdt className="question">Belgium</bdt>
                        <bdt className="statement-end-if-in-editor" />, and the use of the United Nations Convention of
                        Contracts for the International Sale of Goods is expressly excluded. If your habitual residence
                        is in the EU, and you are a consumer, you additionally possess the protection provided to you by
                        obligatory provisions of the law of your country of residence.{' '}
                        <bdt className="question">Plunk</bdt> and yourself both agree to submit to the non-exclusive
                        jurisdiction of the courts of <bdt className="question">Antwerpen</bdt>, which means that you
                        may make a claim to defend your consumer protection rights in regards to these Conditions of Use
                        in{' '}
                        <span style={{fontSize: '15px'}}>
                          <bdt className="block-component" />
                          <bdt className="question">Belgium</bdt>
                    ...
                    <bdt className="block-container if" data-type="if">
                      <bdt data-type="conditional-block">
                        <bdt data-type="body">
                          ...
                          >
                            <strong>
                              <span style={{fontSize: '19px'}}>19. CORRECTIONS</span>
                            </strong>
                          </div>
                          <div className="MsoNormal" style={{lineHeight: 1}}>
                            <br />
                          ...
                          >
                            <strong>
                              <span style={{fontSize: '19px'}}>20. DISCLAIMER</span>
                            </strong>
                          </div>
                          <div className="MsoNormal" style={{lineHeight: 1}}>
                            <br />
                          ...
                          >
                            <strong>
                              <span style={{fontSize: '19px'}}>21. LIMITATIONS OF LIABILITY</span>
                            </strong>
                          </div>
                          <div className="MsoNormal" style={{lineHeight: 1}}>
                            <br />
                          ...
                          >
                            <strong>
                              <span style={{fontSize: '19px'}}>22. INDEMNIFICATION</span>
                            </strong>
                          </div>
                          <div className="MsoNormal" style={{lineHeight: 1}}>
                            <br />
                          ...
                          >
                            <strong>
                              <span style={{fontSize: '19px'}}>23. USER DATA</span>
                            </strong>
                          </div>
                          <div className="MsoNormal" style={{lineHeight: 1}}>
                            <br />
                          ...
                          >
                            <strong>
                              <span style={{fontSize: '19px'}}>26. MISCELLANEOUS</span>
                            </strong>
                          </div>
                          <div className="MsoNormal" style={{lineHeight: 1}}>
                            <br />
                          ...
                          <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5'}}>
                            <span style={{fontSize: '15px'}}>
                              ...
                              >
                                rder to resolve a complaint regarding the Site or to receive further information
                          ...
                          <div className="MsoNormal" data-custom-class="body_text" style={{lineHeight: '1.5'}}>
                            <bdt className="question">
                              <strong>
                                <span style={{fontSize: '15px'}}>support@useplunk.com</span>
                              </strong>
                            </bdt>
                          </div>
                        </bdt>
